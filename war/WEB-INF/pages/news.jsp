...
<t:page>
	<jsp:attribute name="content">
		...
		<c:if test="${isAdmin}">
			<a href="/news?action=edit" class="btn btn-large bg-brandeis-blue-2">Create New Story Now</a>
			<br>
			<br>
			<br>
		</c:if>
		...
		<c:forEach items="${stories}" var="story">
			<div class="card bg-brandeis-blue-0">
				<c:if test="${isAdmin}">
					...
					<h2 class="txt-brandeis-white pad-l-10 margin-t-10 margin-b-10">
						${story.title}
					</h2>
				<c:if test="${isAdmin}">
					</a>
				...
				<div class="card margin-r-10 margin-l-10">
					...
					<c:if test="${story.edited}">
						<h6 class="bg-brandeis-blue-1 txt-brandeis-white pad-t-10 pad-l-10 pad-b-10 margin-t-0 margin-b-0">
